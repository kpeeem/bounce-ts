...
export class Canvas {
  ...
  private gbarLife: HTMLImageElement;
  private gbarRing: HTMLImageElement;
  private gbarCanvas: HTMLCanvasElement;
  private gbarCtx: CanvasRenderingContext2D;
  ...
  constructor(containerId: string, options?: CanvasOptions) {
    ...
    this.gbarLife.src = '/public/assets/tile/gbar_life.png';
    this.gbarRing = new Image();
    this.gbarRing.src = '/public/assets/tile/gbar_ring.png';
  ...
  drawTile(tile: string, i: number, j: number) {
    const x = i * Tile.size;
    const y = j * Tile.size;
